...
model_name = 'ed{}eo{:.0f}cf{}ks{}cd{:.0f}cf{}ks{}cd{:.0f}cf{}ks{}cd{:.0f}ls{}ls{}ls{}ds{}dd{:.0f}ds{}dd{:.0f}ds{}dd{:.0f}'.format(
    embedding_dims, embedding_dropout * 100, 
    filters, kernel_size, conv_dropout * 100, filters2, kernel_size2, conv_dropout2 * 100, 
    filters3, kernel_size3, conv_dropout3 * 100, lstm_output_size, lstm_output_size2, lstm_output_size3, 
    dense_size, dense_dropout * 100, 
    dense_size2, dense_dropout2 * 100, 
    dense_size3, dense_dropout3 * 100)
...
# _________________________________________________________________
# conv1d_2 (Conv1D)            (None, None, 16)          3472
# _________________________________________________________________
# time_distributed_2 (TimeDist (None, None, 16)          0
# _________________________________________________________________
# conv1d_3 (Conv1D)            (None, None, 12)          1356
# _________________________________________________________________
# time_distributed_3 (TimeDist (None, None, 12)          0
# _________________________________________________________________
# bidirectional_1 (Bidirection (None, None, 48)          5472
# _________________________________________________________________
# bidirectional_2 (Bidirection (None, None, 32)          6336
# _________________________________________________________________
# bidirectional_3 (Bidirection (None, None, 24)          3312
# _________________________________________________________________
# time_distributed_4 (TimeDist (None, None, 32)          800
# _________________________________________________________________
# time_distributed_5 (TimeDist (None, None, 32)          0
# _________________________________________________________________
# time_distributed_6 (TimeDist (None, None, 32)          0
# _________________________________________________________________
# time_distributed_7 (TimeDist (None, None, 32)          1056
# _________________________________________________________________
# time_distributed_8 (TimeDist (None, None, 32)          0
# _________________________________________________________________
# time_distributed_9 (TimeDist (None, None, 32)          0
# _________________________________________________________________
# time_distributed_10 (TimeDis (None, None, 24)          792
# _________________________________________________________________
